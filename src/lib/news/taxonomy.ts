...
export const EVENT_RULES: EventRule[] = [
  ...
  },
  {
    ...
    description:
      "Pledge raised, encumbered, or invoked. Forced-sale risk; often a gap-down that can cascade if the price keeps falling.",
    keywords: [
      "promoter pledge",
      "pledged shares",
      "share pledge",
  ...
  {
    id: "qip_block",
    label: "QIP / block deal",
    description:
      "Qualified institutional placement or block/bulk print. Sold on the tape like other dilution, sometimes recovered in a few sessions.",
    keywords: [
  ...
  },
  {
    ...
    label: "USFDA",
    description:
      "Form 483, warning letter, or import alert. Procedural two-obs prints can close green; OAI / import-alert usually does not.",
    keywords: [
      "form 483",
      "usfda",
      "us fda",
  ...
  },
  {
    ...
    description:
      "CRISIL, ICRA, Moody’s, Fitch — not a Street target change. Credit cuts stick more than analyst downgrades.",
    keywords: [
      "credit rating",
      "rating downgrade",
      "cuts rating",
