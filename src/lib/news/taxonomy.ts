...
export const EVENT_RULES: EventRule[] = [
  {
    ...
    keywords: ["beats", "beat estimates", "topped estimates", "eps above", "revenue beat", "better-than-expected earnings", "surpasses estimates"],
    typical1d: 0.018,
    typical5d: 0.012,
    reversal: 0.38,
  },
  ...
  },
  {
    ...
    keywords: ["upgrades", "raised to overweight", "raised to buy", "price target raised", "initiates overweight"],
    typical1d: 0.009,
    typical5d: 0.011,
    reversal: 0.41,
  },
  ...
  },
  {
    ...
    keywords: ["lawsuit", "sued", "investigation", "doj probe", "sec probe", "antitrust", "class action", "settlement"],
    typical1d: -0.019,
    typical5d: -0.017,
    reversal: 0.27,
  },
